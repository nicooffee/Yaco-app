...
(   
    ...
    CONSTRAINT "PK_FLASHCARD" PRIMARY KEY ( "usu_id","pal_id" ),
...
(
    ...
    CONSTRAINT "PK_REVISION" PRIMARY KEY ( "rev_id", "usu_id","pal_id" ),
    CONSTRAINT "FK_FLA_ID" FOREIGN KEY ( "pal_id", "usu_id" ) REFERENCES "FLASHCARD" ( "pal_id", "usu_id" )
);