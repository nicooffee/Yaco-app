...
(
    ...
    CONSTRAINT "FK_USUPAL" FOREIGN KEY ( "usu_id","pal_id" ) REFERENCES "USUARIO_PALABRA" ( "usu_id","pal_id" ) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "FK_DEF" FOREIGN KEY ( "def_id" ) REFERENCES "DEFINICION" ( "def_id" ) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
    ...
    "rev_es_correcta"    boolean  NOT NULL,
